...
const MobileNavigation = () => {
    ...
    if (showMenu) {
        menu =  <div className={styles.main_Mobile_Bottom}>
                    ...
                    <div>
                        <NavLink to='/categoryPage/Cars' className={styles.main_Header_Items} style={ ( {isActive} ) => { return { color: isActive? 'white' : 'black', backgroundColor: isActive? 'black' : 'white'} } }>Cars</NavLink>
                    </div>
                    <div>
